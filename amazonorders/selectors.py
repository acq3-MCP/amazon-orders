...
class Selectors:
    ...
    ORDER_SKIP_TOTALS = [
        ...
        # Identifies a cancelled order on the current details layout, which renders the cancellation as the
        # shipment-status heading ("Cancelled" over "Your order was cancelled …") with no alert box and no totals
